...
export function EpcQuoteSection() {
    return (
        <section className="w-full bg-white py-16 md:py-24 px-4 sm:px-6 lg:px-8" id="quote">
                ...
                >
                    ...
                    <p className="text-[#646A7A] text-[15px] leading-relaxed mb-8">
                        <SuisseIntlText weight="regular">
                            Please complete this form for a no obligation EPC quote.<br />
                            You will be contacted shortly by one of our friendly advisors to kick start the process.
                        </SuisseIntlText>
                    </p>
                    ...
                    <form className="w-full space-y-8">
                        ...
                        <div className="border border-[#E5E5E5] group">
                            <div className="bg-black text-white px-5 py-3.5">
                                <SuisseIntlText weight="semibold" className="text-sm tracking-wide">Your Details</SuisseIntlText>
                            </div>
                            <div className="p-5 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center">
                                        <SuisseIntlText weight="regular">Contact Name *</SuisseIntlText>
                                    </label>
                                    <input type="text" className="w-full h-11 border border-[#E5E5E5] px-3 outline-none focus:border-[#99BC0F] text-sm text-[#0A0A0B] transition-colors" />
                                </div>
                                {/* Right Col */}
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center">
                                    ...
                                    <input type="email" className="w-full h-11 border border-[#E5E5E5] px-3 outline-none focus:border-[#99BC0F] text-sm text-[#0A0A0B] transition-colors" />
                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center">
                                        <SuisseIntlText weight="regular">Phone Number *</SuisseIntlText>
                                    </label>
                                    <input type="tel" className="w-full h-11 border border-[#E5E5E5] px-3 outline-none focus:border-[#99BC0F] text-sm text-[#0A0A0B] transition-colors" />
                                </div>
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center">
                                        <SuisseIntlText weight="regular">Reason for the EPC *</SuisseIntlText>
                                    </label>
                                    <select className="w-full h-11 border border-[#E5E5E5] px-3 bg-white outline-none focus:border-[#99BC0F] text-sm appearance-none flex items-center bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%221.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22M6 9l6 6 6-6%22/></svg>')] bg-size-[16px] bg-position-[right_12px_center] bg-no-repeat pr-10 text-[#646A7A] transition-colors">
                        ...
                        <div className="border border-[#E5E5E5]">
                            <div className="bg-black text-white px-5 py-3.5">
                                <SuisseIntlText weight="semibold" className="text-sm tracking-wide">Property Details</SuisseIntlText>
                            </div>
                            <div className="p-5 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center">
                                        <SuisseIntlText weight="regular">Property Type *</SuisseIntlText>
                                    </label>
                                    <select className="w-full h-11 border border-[#E5E5E5] px-3 bg-white outline-none focus:border-[#99BC0F] text-sm appearance-none flex items-center bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%221.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22M6 9l6 6 6-6%22/></svg>')] bg-size-[16px] bg-position-[right_12px_center] bg-no-repeat pr-10 text-[#646A7A] transition-colors">
                                        <option value="">Select</option>
                                    </select>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center">
                                        <SuisseIntlText weight="regular">No Bed Rooms *</SuisseIntlText>
                                    </label>
                                    <select className="w-full h-11 border border-[#E5E5E5] px-3 bg-white outline-none focus:border-[#99BC0F] text-sm appearance-none flex items-center bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%221.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22M6 9l6 6 6-6%22/></svg>')] bg-size-[16px] bg-position-[right_12px_center] bg-no-repeat pr-10 text-[#646A7A] transition-colors">
                                        <option value="">Select</option>
                                    </select>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center pr-2">
                                        <SuisseIntlText weight="regular">Required Inspection<br className="hidden sm:block" /> Date</SuisseIntlText>
                                    </label>
                                    <select className="w-full h-11 border border-[#E5E5E5] px-3 bg-white outline-none focus:border-[#99BC0F] text-sm appearance-none flex items-center bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%221.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22M6 9l6 6 6-6%22/></svg>')] bg-size-[16px] bg-position-[right_12px_center] bg-no-repeat pr-10 text-[#646A7A] transition-colors">
                                        <option value="">Select</option>
                                    </select>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] md:grid-cols-[120px_1fr] lg:grid-cols-[140px_1fr] sm:items-center gap-2 sm:gap-4">
                                    <label className="text-[13px] text-[#0A0A0B] leading-tight flex items-center pr-2">
                                        <SuisseIntlText weight="regular">Prefered Inspection<br className="hidden sm:block" /> Time Scale</SuisseIntlText>
                                    </label>
                                    <select className="w-full h-11 border border-[#E5E5E5] px-3 bg-white outline-none focus:border-[#99BC0F] text-sm appearance-none flex items-center bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2216%22 height=%2216%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%221.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22><path d=%22M6 9l6 6 6-6%22/></svg>')] bg-size-[16px] bg-position-[right_12px_center] bg-no-repeat pr-10 text-[#646A7A] transition-colors">
                                        <option value="">Select</option>
                                    </select>
                        ...
                        <div className="flex justify-center pt-4">
                            <Button className="w-full h-12 md:h-14 bg-[#9DC32A] hover:bg-[#8bb023] text-white font-medium rounded-lg text-lg shadow-none">
