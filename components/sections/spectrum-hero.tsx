  ...
  return (
    <section className="relative w-full overflow-hidden pt-36 md:pt-48">
      ...
      <div className="relative mx-auto w-full max-w-[1400px] px-6 lg:px-10 z-10">
        ...
        <FadeIn
          delay={0.1}
          className="flex flex-col items-center pb-8 md:pb-12 text-center relative z-20"
        >
          <DelightText
            weight="extrabold"
            className="text-3xl md:text-5xl font-bold lg:text-6xl leading-tight tracking-tighter text-black max-w-4xl text-balance"
          >
            Accurate Property <span className="text-primary">Surveys</span> You
            Can Rely On
          </DelightText>
          <SuisseIntlText
            weight="regular"
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4 md:gap-6">
            <p className="text-base md:text-lg max-w-[320px] font-suisse-intl-semibold text-black">
      ...
      <FadeIn
        delay={0.3}
        className="relative -top-20 md:-top-20 w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[550px] mt-8"
      >
        <Image
