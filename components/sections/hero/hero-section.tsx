...
export const HeroSection = function ({
  image,
  children,
  title = "Why Choose Spectrum Property Services?",
  description = "",
        ...
        <div className="container p-4 pb-0 md:px-6 mx-auto">
          <div className="space-y-10 md:space-y-10 items-center justify-between ">
            ...
            >
              ...
              <DelightText
                weight="bold"
                className="font-bold text-center text-3xl max-w-2xl lg:text-[50px] md:text-[2.5rem] text-black mb-5 md:leading-[50px] leading-[35px] letter-spacing-[-1%]"
              >
                {title}
              </DelightText>
              {description}
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <p className="text-base md:text-lg max-w-[260px] font-suisse-intl-semibold text-black">
