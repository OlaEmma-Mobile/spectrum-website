      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          <StaggerContainer delay={0.2} className="space-y-6">
            {/* Header */}
            <div className="mb-12">
              <p className="text-base -tracking-normal font-mono font-medium uppercase text-black mb-3">
                Why Spectrum
              </p>
              <DelightText
                weight="bold"
                className="text-2xl text-black md:text-4xl font-bold leading-tight"
              >
                Inspecting Building With{" "}
              ...
              >
                Start With Accurate Data. Build With Confidence. We deliver
                precise building insights to support smart, successful
                development.
              </SuisseIntlText>
            </div>
          ...
          <FadeIn
            delay={0.4}
            className="relative w-full h-full max-h-[450px] md:max-h-[785px] rounded-3xl overflow-hidden shadow-xl"
          >
            <Image
              src="/images/worker.jpg"
              alt="Building survey in progress"
              width={283}
              height={785}
...
function FeatureCard({
  ...
  return (
    <div
      className={`flex gap-4 p-5 items-center rounded-2xl transition ${
        highlight ? "bg-gray-100" : "bg-transparent hover:bg-gray-50"
      }`}
    >
      ...
      <div>
        ...
        <SuisseIntlText
          weight="regular"
          className="text-sm text-[#71717B] leading-tight"
        >
          {description}
        </SuisseIntlText>
      </div>
