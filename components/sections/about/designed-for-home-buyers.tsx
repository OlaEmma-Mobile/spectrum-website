          ...
          <div className="w-full text-white">
            ...
            <p className="text-[#A1A1AA] text-base leading-relaxed mb-12">
              <SuisseIntlText weight="regular">
                Our reports are written in plain, easy-to-understand language,
                not technical jargon. We focus on what truly matters to you as a
                buyer and explain how any issues could affect value, safety, or
                future costs.
              </SuisseIntlText>
            </p>
                ...
                return (
                  <div key={item.slug} className="flex items-start gap-5 group">
                    ...
                    <div>
                      <SuisseIntlText
                        weight="medium"
                        className="md:text-xl text-base font-semibold text-white mb-2"
                      >
                        {item.title}
                      </SuisseIntlText>
                      <p className="text-[#A1A1AA] text-sm leading-snug mb-2 max-w-sm">
                        <SuisseIntlText weight="regular">
                          ...
                          <Link
                            href={`/home-buyers/${item.slug}`}
                            className="inline-flex items-center text-[#CAE366] text-xs font-semibold tracking-wide uppercase hover:text-white transition-colors group/link"
                          >
                            Read More
